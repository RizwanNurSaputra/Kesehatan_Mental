...
const Home = () => {
    return <div id="home" className="w-full px-5 lg:px-[72px]">
        <div className="pt-14 max-w-[700px] flex flex-col justify-center gap-y-5">
            <h1 className="font-bold text-5xl text-gray-500 text-[20px] gap-y-3">Temukan Kesehatan Mental
            <br/>yang Lebih Baik Bersama 
            <br/><span className="text-blue-600">Inner</span>strength.</h1>
            <p className=" pt-14">InnerStrength hadir untuk membantu Anda mencapainya, 
